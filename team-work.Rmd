...
| Prabhjot Singh  - I found myself with Yelia Ye doing most of the communication and reminding the other group members about the deadlines and what was expected. We were able to divide the work per milestone for example, I did the data analysis portion.

| Chenyi Zao - Chenyi did the assigned work well without any errors but I never saw them taking initiative or be the leader of the group.

| Yelia Ye - Yelia was very good in communicating and reminding people of the deadlines. Her work was always up to the mark. They knew when to be the leader and when to listen.

| Yunxuan Zhang - While they did the assigned work well, I found them to be very hard to communicate with at times as I would only see their message on the group chat on the day of the deadline. Moreover, In one instance, I saw them change a significant portion of my work with dat analysis portion without communicating with me. Although, I found their work impressive the decision to directly make the changes and not consult me was very disrespectful.
